MAP_SSECURITY_OPTION_NAME = 'xpath://h1[contains(text(), "Taxa Social Única")]'
...
MAP_TOTAL_AMMOUNT = 'xpath://input[@id="bb_element_11"]'
MAP_TAX_ID = 'xpath://input[@id="bb_input_4"]'
MAP_SUBMIT_BUTTON = 'xpath://bb-load-button-ui[@class="bb-button-bar__button"]'

MAP_SERVICES_OPTION_NAME = 'xpath://h1[contains(text(), "Serviços")]'
