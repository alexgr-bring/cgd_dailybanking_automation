...
MAP_SS_MAIN_FIRST_ORIGIN_ACCOUNT = 'xpath://ng-dropdown-panel[@class="ng-dropdown-panel ng-select-bottom"]/div[2]/div[2]/div[1]'
...
MAP_SS_MAIN_PAYMENT_PERIOD = 'xpath://fieldset[@class="bb-fieldset"]//child::div[3]//child::div[2]//span'
...
MAP_SS_REVIEW_PAYMENT_PERIOD = 'xpath://fieldset[@class="bb-fieldset"]//child::div[3]//child::div[2]//span'
...
MAP_SERV_REVIEW_TOTAL_AMOUNT = 'xpath://input[@id="bb_element_11"] | //input[@id="bb_element_123"]'
